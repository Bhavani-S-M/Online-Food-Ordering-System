...
INSERT INTO `restaurant` (`rs_id`, `c_id`,`c_name`, `title`, `email`, `phone`, `url`, `o_hr`, `c_hr`, `o_days`, `address`, `image`, `date`) VALUES
(1, 1,'Continental', 'North Street Tavern', 'nthavern@mail.com', '3547854700', 'www.northstreettavern.com', '8am', '8pm', 'mon-sat', '1128 North St, White Plains', '6290877b473ce.jpg', '2022-05-27 08:10:35'),
(2, 2,'Italian', 'Eataly', 'eataly@gmail.com', '0557426406', 'www.eataly.com', '11am', '9pm', 'Mon-Sat', '800 Boylston St, Boston', '606d720b5fc71.jpg', '2022-05-27 08:06:41'),
(3, 3, 'Chinese','Nan Xiang Xiao Long Bao', 'nanxiangbao45@mail.com', '1458745855', 'www.nanxiangbao45.com', '9am', '8pm', 'mon-sat', 'Queens, New York', '6290860e72d1e.jpg', '2022-05-27 08:04:30'),
(4, 4, 'American','Highlands Bar & Grill', 'hbg@mail.com', '6545687458', 'www.hbg.com', '7am', '8pm', 'mon-sat', '812 Walter Street', '6290af6f81887.jpg', '2022-05-27 11:01:03');
...
INSERT INTO `users` (`username`, `f_name`, `l_name`, `email`, `phone`, `password`, `address`,`o_id`,`u_id`, `title`, `quantity`, `price`, `status`, `date`) VALUES
( 'eric', 'Eric', 'Lopez', 'eric@mail.com', '1458965547', 'a32de55ffd7a9c4101a0c5c8788b38ed', '87 Armbrester Drive',1,1,'Spring Rolls', 2, '6.00', 'rejected', '2022-05-27 08:40:36'),
( 'harry', 'Harry', 'Holt', 'harryh@mail.com', '3578545458', 'bc28715006af20d0e961afd053a984d9', '33 Stadium Drive',3,2,'Chicken Madeira', 1, '23.00', 'closed', '2022-05-27 08:41:07'),
( 'james', 'James', 'Duncan', 'james@mail.com', '0258545696', '58b2318af54435138065ee13dd8bea16', '67 Hiney Road',5,3, 'Meatballs Penne Pasta', 1, '10.00', 'closed', '2022-05-27 08:41:37'),
( 'christine', 'Christine', 'Moore', 'christine@mail.com', '7412580010', '5f4dcc3b5aa765d61d8327deb882cf99', '114 Test Address', 7,4,'Yorkshire Lamb Patties', 1, '14.00', 'closed', '2022-05-01 05:14:42'),
( 'scott', 'Scott', 'Miller', 'scott@mail.com', '7896547850', '5f4dcc3b5aa765d61d8327deb882cf99', '63 Charack Road', 8,5,'Lobster Thermidor', 1, '36.00', 'closed', '2022-05-27 10:53:51'),
( 'liamoore', 'Liam', 'Moore', 'liamoore@mail.com', '7896969696', '5f4dcc3b5aa765d61d8327deb882cf99', '122 Bleck Street', 9,6,'Stuffed Jacket Potatoes', 1, '8.00', 'rejected', '2022-05-27 12:57:00');
